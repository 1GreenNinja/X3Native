...
Y=−200, **50×100×30 ft** main room. Suspended **DJ booth** (turntables, mixer, 2 OLED, keypad door), **the ORB** (2 m mirror ball), **aerial bar** + **ground bar** (7 stools), 2-story engine-room/lounge (12-step stair), VIP couches. **Real PA rig:** 4× SVS PB16-Ultra subs, 8 pairs JBL JRX200 + 2500 W amps, 4× JBL 18" subs, 16× surrounds; **20 blacklights** (vertical 4 ft wall tubes every 12 ft, centers 5 ft off the floor, each casting a UV point light — Tim spec 2026-07-17; was 28 @ 10 ft emissive-only); 6-screen TV multiplex (POE). 80 m cull, materials frozen, meshes merged.
