...
|---|---|---|---|---|---|---|---|
| D1 | Vulkan device + swapchain + cmd buffers | `IRenderDevice` | `engine/_gpl_rbdoom/rhi/` | `specs/D1-render-device.spec.md` | TODO | — | reimplement on vk-bootstrap + VMA |
...
| D5 | Pak / virtual filesystem | `IAssetSource` | `engine/_gpl_rbdoom/vfs/` | `specs/D5-asset-source.spec.md` | TODO | — | zip via miniz (MIT) |
