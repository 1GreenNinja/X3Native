...
// (leak-clean round-trip), intensity ramp/clamp, degenerate from==to skip, and
// that the baked energy field is non-trivial (rings + edge structure). Ported
// byte-faithfully from the pre-split monolith main() inline block into this
// lane TU (integration feast fold of the 14900K's feat/tractor-beam lane).
// ---------------------------------------------------------------------------
