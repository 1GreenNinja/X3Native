...
int main(int argc, char** argv) {
    ...
    if (o.vehLookShot)  o.worldMode = "drive";   // cosmetic-look proof stages in the drive world
    ...
    // ======================================================================
    {
        ...
        _hc.rtMatVerifyShot  = o.rtMatVerifyShot;  _hc.rtMatVerifyShotDir = o.rtMatVerifyShotDir;
        ...
        _hc.csmShot          = o.csmShot;          _hc.csmShotDir       = o.csmShotDir;
        ...
        _hc.vehLookShot      = o.vehLookShot;      _hc.vehLookShotDir   = o.vehLookShotDir;
