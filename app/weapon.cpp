...
std::vector<WeaponDef> makeDefaultRoster() {
    ...
    { WeaponDef w; w.name="bazooka"; w.kind=FireKind::Projectile; w.damage=95; w.fireRate=0.7f;
      ...
      w.reloadTime=2.6f; w.projSpeed=35.0f; base(w); w.viewmodelGlb="WeaponRocketLauncher.glb"; w.vmScale=0.12f; w.muzzleFx="muzzle_plasma"; w.impactFx="impact_plasma"; r.push_back(w); }
    ...
    { WeaponDef w; w.name="laser"; w.kind=FireKind::Hitscan; w.automatic=true; w.damage=15; w.fireRate=10.0f;
      ...
      w.reloadTime=2.0f; base(w); w.viewmodelGlb="WeaponRailGun.glb"; w.vmScale=0.16f; r.push_back(w); }
    ...
    { WeaponDef w; w.name="lightning"; w.kind=FireKind::Hitscan; w.automatic=true; w.damage=12; w.fireRate=12.0f;
      ...
      w.reloadTime=2.2f; base(w); w.viewmodelGlb="WeaponRailGun.glb"; w.vmScale=0.16f; r.push_back(w); }
    ...
    { WeaponDef w; w.name="flamethrower"; w.kind=FireKind::Hitscan; w.automatic=true; w.damage=8; w.fireRate=16.0f;
      ...
      w.reloadTime=2.5f; base(w); w.viewmodelGlb="WeaponRocketLauncher.glb"; w.vmScale=0.12f; r.push_back(w); }
    ...
    { WeaponDef w; w.name="bfg"; w.kind=FireKind::Projectile; w.damage=200; w.fireRate=0.4f;
      ...
      w.reloadTime=3.0f; w.projSpeed=28.0f; base(w); w.viewmodelGlb="WeaponBFG.glb"; w.vmScale=0.18f; w.muzzleFx="muzzle_plasma"; w.impactFx="impact_plasma"; r.push_back(w); }
    ...
    { WeaponDef w; w.name="railgun"; w.kind=FireKind::Hitscan; w.damage=150; w.fireRate=1.0f;
      ...
      w.reloadTime=2.4f; base(w); w.viewmodelGlb="WeaponRailGun.glb"; w.vmScale=0.16f; r.push_back(w); }
    ...
    { WeaponDef w; w.name="napalm"; w.kind=FireKind::Projectile; w.damage=40; w.fireRate=1.5f;
      ...
      w.reloadTime=2.4f; w.projSpeed=30.0f; base(w); w.viewmodelGlb="WeaponRocketLauncher.glb"; w.vmScale=0.12f; w.muzzleFx="muzzle_plasma"; w.impactFx="impact_plasma"; r.push_back(w); }
