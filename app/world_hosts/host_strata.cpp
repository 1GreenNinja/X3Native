// --world strata host — THE DESCENT (facility base Y=0 -> Club 1127 Y=-200).
// RE-HOMED from playable-build's pre-split main() inline block (fd94c92) into the
// #28 deep-split world-host registry, per the ATTENTION_FableAAA fold contract
