// --world elevator host (+ --screenshot-elevator) — THE CENTERPIECE self-contained
// THICK dark-glass elevator showcase, lifted VERBATIM from the playable-build
