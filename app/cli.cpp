...
void parseCli(int argc, char** argv, CliOptions& o) {
    ...
    for (int i = 1; i < argc; ++i) {
        ...
        else if (a == "--verbose-ai") o.aiVerbose = true;
        else if (a == "--test-monsterperception") o.testMonsterPerception = true;
        ...
        if (false) {}
            ...
            o.elevShot = true; o.worldMode = "elevator"; o.screenshot = true;
        ...
        else if (a == "--test-npcchar") o.testNpcChar = true;
        ...
        else if (a == "--test-strata") o.testStrata = true;
