...
void parseCli(int argc, char** argv, CliOptions& o) {
    ...
    for (int i = 1; i < argc; ++i) {
        ...
        else if (a == "--test-enemy-scale") o.testEnemyScale = true;
        ...
        else if (a == "--test-riverrapids") o.testRiverRapids = true;
        ...
        else if (a == "--test-drivelayer") o.testDriveLayer = true;
        else if (a == "--test-stack") o.testStack = true;
