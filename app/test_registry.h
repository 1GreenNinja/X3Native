...
struct TestFlags {
    ...
    bool testNpcChar = false;   // --test-npcchar: animated citizen BODY (rig/anim/ragdoll/spawn)
    bool testHacking = false;   // --test-hacking: WD2 hackable registry (scatter/scan/effects/karma)
