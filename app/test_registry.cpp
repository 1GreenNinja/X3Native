...
#include "level_lint.h"           // Gate A geometric lint + Gate C golden-path trace
...
#include "strata.h"               // STRATA descent self-test (--test-strata)
#include "elevator_showcase.h"    // CENTERPIECE dark-glass elevator (--test-elevator-showcase)
