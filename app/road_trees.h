...
// (~100-200 trees). The GLBs ship Draco geometry but NO base-colour textures
// (only a bark normal map on the poplar), so both species are flat-tinted
// via setMaterialOverride — a believable green at road distance, not
// per-leaf art. Their far-LOD "Billboard" card nodes are skipped.
// ===========================================================================
