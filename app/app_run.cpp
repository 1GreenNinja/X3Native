                    ...
                    if (canonPlay.built() &&
                        ...
                        auto proofBars = [&](x3::game::MonsterManager& mm) {
                            for (uint32_t mi = 0; mi < mm.count(); ++mi) {
                                ...
                                const float lowH = 1.0f - frac;
                                const float outl[4]   = { 0.0f, 0.0f, 0.0f, 0.65f };
                                const float frameC[4] = { 0.78f, 0.86f, 1.00f, 0.95f };
                                const float backC[4]  = { 0.04f, 0.05f, 0.08f, 0.85f };
                                const float baseC[4]  = { 0.52f + 0.30f*lowH, 0.55f - 0.20f*lowH, 0.62f - 0.30f*lowH, 1.0f };
