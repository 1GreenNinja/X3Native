...
#include "canon_aliens.h" // READ-ONLY: canon-alien roster (SaurianWarlord for the L10 boss)
...
public:
    ...
    // The L10 Saurian Warlord boss (canon-aliens Reptilian; HP 540, Boss-typed,
    // 3 phases + memory-flash window aligned to the Adaptive-Hide rhythm). PRESENT
    // at build but INERT until the L10WarlordArena trigger arms (m_warlordSpawned
    // latches → tick/onFire/draw stop gating it).
