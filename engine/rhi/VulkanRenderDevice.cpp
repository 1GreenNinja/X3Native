...
private:
    ...
    bool createPost() {
        ...
        VkDescriptorPoolSize ps[3]{
            ...
            // COMPOSITE-INTRO UNION: composite sets are now 4 samplers each (HDR +
            // bloom + god-rays + lens) x2 variants; + 2 AE; + 3 TAA/frame; + the
            // god-rays own set (2: scene + depth); + the lens own sets (2/frame).
            { VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER,
              single + 4*2 + 1*2 + 3*kFramesInFlight + 2 + 2*kFramesInFlight },
