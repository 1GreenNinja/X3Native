...
void VulkanRenderDevice::prepareFrameData() {
        ...
        if (fr.skyMapped) {
            ...
            // params.w (was reserved 0): per-scene NEBULA strength (SkyParams.nebula;
            // default 0 keeps every existing sky byte-identical).
            sky.params   = glm::vec4(m_sky.haze, m_sky.exposure, m_skyTime, m_sky.nebula);
