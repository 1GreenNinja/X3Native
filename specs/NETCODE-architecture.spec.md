...
- X3Native internal: `docs/CONVENTIONS.md` (coords/quat), `docs/X3NATIVE_ROADMAP.md` (D-JOB, D-PHYS, Open Decision #1 origin rebasing), `specs/J-character-animation.spec.md` (deterministic replay, anim state), `specs/K-gpu-destruction.spec.md` (one-way visual coupling, break events).
