...
3. **On 13700K:**
   ...
   - `cloudflared tunnel route dns djbooth-fleet-chat chat.<CHOSEN_DOMAIN>`
...
4. **Verify:**
   ...
   - `curl -I https://chat.<CHOSEN_DOMAIN>/_matrix/client/versions` from external network — tunnel ✓
