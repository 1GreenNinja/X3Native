...
# skinned four of the five arsenal weapons with a foreign atlas (the "camo splotch /
# pale slab" bug). Each Rodin weapon ships its OWN texture set NEXT TO its .obj, so
# <texdir> now DEFAULTS to the OBJ's own directory -- convert each weapon from its own
# folder and it gets its own maps. Only override <texdir> deliberately.
#
