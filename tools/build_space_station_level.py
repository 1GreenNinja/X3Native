...
OUT_PATH = r"D:\GameDev\X3Native-dragdrop\assets\levels\space_station.leveldoc.json"
...
def place_seated(basename, pack_folder, pack_key, cx, bottom_y, cz, yaw=0.0,
                  scale=1.0, tint=(1, 1, 1), name=None):
...
# Scatter detail on/around the stargate pad: solar panels, exterior lights,
# antennae, air grids -- seated on the deck (GY) at its perimeter.
place("Solar_Panel_01.glb", PACK3, VOL3, -10.0, GY, 20.0, yaw=0.4, name="solar_a")
place("Solar_Panel_01.glb", PACK3, VOL3, 8.0, GY, 20.0, yaw=-0.4, name="solar_b")
